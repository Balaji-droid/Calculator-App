...
if __name__ == "__main__":
    ...
    gui.title("BALA Simple Calculator")
    ...
    button = Button(gui, text=' 1 ', fg='white', bg='black',
                     commtnand=lambda: press(1), height=1, width=7)
    ...
    clear = Button(gui, text='Clear', fg='white', bg='violet',
